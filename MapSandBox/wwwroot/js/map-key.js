...
(function () {
    ...
    const SECTIONS = [
        ...
        },
        {
            ...
            rows: [
                { swatch: 'box', color: 'rgb(211,47,47)', label: '200+' },
                { swatch: 'box', color: 'rgb(255,112,67)', label: '50–199' },
                { swatch: 'box', color: 'rgb(255,183,77)', label: '10–49' },
                { swatch: 'box', color: 'rgb(65,182,196)', label: '1–9' },
                { swatch: 'box', color: 'rgb(200,200,200)', label: '0 / unknown' },
