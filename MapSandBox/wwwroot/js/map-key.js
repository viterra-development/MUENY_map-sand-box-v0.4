...
(function () {
    ...
    const SECTIONS = [
        ...
        },
        {
            ...
            rows: [
                { swatch: 'box', color: 'rgb(23,77,88)', label: '200+' },
                { swatch: 'box', color: 'rgb(66,125,128)', label: '50–199' },
                { swatch: 'box', color: 'rgb(148,177,175)', label: '10–49' },
                { swatch: 'box', color: 'rgb(204,203,195)', label: '1–9' },
                { swatch: 'box', color: 'rgb(227,225,219)', label: '0 / unknown' },
